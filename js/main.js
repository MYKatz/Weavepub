...
var router = new VueRouter({
    routes: [
        ...
        { path: '/mypapers', component: { template: '<div><navigation-menu activePage="mypapers"></navigation-menu><paper-viewer title="My Papers" loadPapersFrom="mypapers"></paper-viewer><footer-bar></footer-bar></div>' } },
